...
import 'travelers_posts_screen.dart'; // ✅ Added import for TravelersPostsScreen
...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SizedBox(
        ...
        child: Stack(
          children: [
            // 1. Top Area Gradient Oval Design
            Positioned(
            ...
            Positioned(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  // ✅ Traveler’s Posts Navigation Update
  ...
  // Helper method for building consistent menu items
